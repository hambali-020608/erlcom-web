...
export default function Aside({ user }) {
  ...
  const toggleAsideDropdown = () => {
    setIsAsideDropdownOpen(!isAsideDropdownOpen);
  };
    ...
    <>
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center">
              <div className="flex items-center ms-3">
                ...
                <div
                  className={` ${
                    isUserDropdownOpen ? "absolute right-0 top-10" : "hidden"
      ...
      <aside
        ...
        className={`fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform bg-white border-r border-gray-200 dark:bg-gray-800 dark:border-gray-700 
              ${
                isAsideDropdownOpen ? "translate-x-0" : "-translate-x-full"
              } sm:translate-x-0`}
        aria-label="Sidebar"
      >
