  ...
  return (
    <>
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-6 xl:grid-cols-4 2xl:gap-7.5">
        <CardDataStats title="Total Siswa" total={countAttedance.jumlahAbsen} rate="0.43%" levelUp>
        ...
        <CardDataStats title="Total Kelas" total="100k" rate="4.35%" >
          <svg
            className="fill-primary dark:fill-white"
            width="20"
            height="22"
        ...
        <CardDataStats title="Total Pemasukan" total={countClass.jumlahCourse} rate="2.59%" >
          <svg
            className="fill-primary dark:fill-white"
            width="22"
            height="22"
